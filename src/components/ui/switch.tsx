  ...
  return (
    <SwitchPrimitive.Root
      ...
      className={cn(
        ...
        "data-[state=unchecked]:bg-[var(--color-surface-2)] data-[state=unchecked]:border data-[state=unchecked]:border-[var(--color-border-strong)]",
        className,
      )}
      {...props}
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          ...
          "data-[state=checked]:translate-x-[14px] data-[state=checked]:bg-[var(--color-primary-foreground)]",
          "data-[state=unchecked]:translate-x-[1px] data-[state=unchecked]:bg-[var(--color-fg-2)]",
        )}
      />
    </SwitchPrimitive.Root>
  );
