  ...
  return (
    <SonnerToaster
      ...
      toastOptions={{
        classNames: {
          toast:
            "bg-[var(--color-surface-1)] border border-[var(--color-border-strong)] rounded-md shadow-lg text-[var(--color-fg-1)]",
          title: "text-[13px] font-medium",
          description: "text-[11.5px] font-mono text-[var(--color-fg-3)]",
