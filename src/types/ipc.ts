...
export type EstimateMode = "move-same-volume" | "copy" | "cross-device";

export type EstimateConfidence = "low" | "medium" | "high";

export type PlanEstimateDto = {
    mode: EstimateMode;
    totalFiles: number;
    totalBytes: number;
    estimatedMsLow: number;
    estimatedMsHigh: number;
    confidence: EstimateConfidence;
};

export type PreviewPlanResponseDto = {
    plan: SortPlan;
