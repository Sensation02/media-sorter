...
| [EPIC-04](epic-04-geo.md)                         | ⚪ pending     | Offline reverse geocoding (GPS → city / place name)             |
| [EPIC-05](epic-05-planner.md)                     | ⚪ pending     | Sort planner — turn a rule + scan into a move plan              |
